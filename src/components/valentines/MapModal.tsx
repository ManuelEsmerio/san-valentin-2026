...
export default function MapModal({ 
  ...
  return (
    ...
    >
      <div
        className={cn(
          'relative w-full max-w-2xl m-4 bg-card text-card-foreground rounded-2xl shadow-2xl shadow-primary/20 border border-primary/10 transition-all duration-300 dark:bg-zinc-900 dark:border-zinc-800 flex flex-col max-h-[90vh]',
      ...
      >
        ...
        {/* Scrollable Content */}
        <div className="px-6 sm:px-8 py-4 text-center overflow-y-auto">
        ...
        {/* Footer with buttons */}
        <div className="p-6 sm:p-8 pt-4 text-center mt-auto border-t border-border">
