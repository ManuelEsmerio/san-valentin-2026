        ...
        <div className="flex flex-col items-center gap-4 w-full">
            ...
            >
             ...
             <Button
                ...
                className="w-full max-w-sm text-center group flex items-center justify-center gap-2 px-4 py-3 rounded-full bg-accent text-accent-foreground font-semibold hover:bg-accent/90 transition-all duration-300 shadow-lg hover:shadow-xl active:scale-95 h-auto text-base whitespace-normal"
            >
