...
const multipleChoiceQuestions: MultipleChoiceQuestion[] = [
    ...
    { id: 6, type: "multiple-choice", question: "¿Quién se duerme primero casi siempre?", options: ["Yo", "Tú", "Tomás", "Los tres al mismo tiempo"], correctAnswer: "Yo", image: 'trivia-6', hint: "El que madruga..." },
    { id: 7, type: "multiple-choice", question: "¿Qué apodo usamos más entre nosotros?", options: ["Mi Amor", "Mi Chula", "Mi Reina", "La Chama"], correctAnswer: ["Mi Chula", "La Chama", "Mi Reina"], image: 'trivia-7', hint: "Son cortos, dulces y muy nuestros. ¡Hay dos correctos!" },
